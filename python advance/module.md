...
WHAT IS MODULES ?
  ...
  a module is a  python file having (.py)  extentions containing functions, variables, classes, or executable code that can be reused in other Python programs.
...
WHAT IS PACKAGE ?
 ...
 the collection of modules  its called as  package
